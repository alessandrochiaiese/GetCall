    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_regions', models.ManyToManyField(related_name='engagement_program_regions', to='accounts.region')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='referrals', to='referral.referralprogram')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('programs', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='engagement_program_partecipation_programs', to='referral.referralprogram')),
                ('referral_codes', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='engagement_program_partecipation_referral_codes', to='referral.referralcode')),
            ],
            options={
