"""
Django settings for getcall project.
...
WSGI_APPLICATION = 'getcall.wsgi.application'
...
SWAGGER_SETTINGS = {
    ...
    'SECURITY_DEFINITIONS': {
        ...
        'Get Call API - Swagger': {
            'type': 'oauth2',
            'authorizationUrl': '/getcall/o/authorize',
            'tokenUrl': '/getcall/o/token/',
            'flow': 'accessCode',
            'scopes': {
